...
<li class="pc-item">
  <a href="{{ Auth::user()->isTeamLead() ? route('lead.tasks.index') : route('tasks.index') }}" class="pc-link">
    ...
    <span class="pc-mtext" data-i18n="Tasks">Tasks</span>
  </a>
</li>
<li class="pc-item">
  <a href="{{ route('whoswho.index') }}" class="pc-link">
    <span class="pc-micon">
      <svg class="pc-icon">
...
<li class="pc-item">
  <a href="{{ route('noticeboard.index') }}" class="pc-link">
    <span class="pc-micon">
      <svg class="pc-icon">
        <use xlink:href="#custom-notification"></use>
      </svg>
    </span>
    <span class="pc-mtext" data-i18n="Noticeboard">Noticeboard</span>
  </a>
</li>
<li class="pc-item">
...
<li class="pc-item pc-caption">
  <label data-i18n="Template Pages">Template Pages</label>
</li>
