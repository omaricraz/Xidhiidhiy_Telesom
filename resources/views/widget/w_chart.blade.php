...
<x-breadcrumb item="Widget" active="Chart"/>
        <div class="row">
...
@section('scripts')
    ...
    <script src="/build/js/widgets/monthly-report-graph.js"></script>
    <script src="/build/js/widgets/sales-report-chart.js"></script>
    <script src="/build/js/widgets/acquisition-chart.js"></script>
