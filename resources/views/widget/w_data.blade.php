...
<x-breadcrumb item="Widget" active="Data"/>
        <div class="row">
              ...
              <ul class="list-group list-group-flush border-top-0">
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="/build/images/user/avatar-1.jpg" alt="user-image" class="user-avtar rounded wid-50 hie-50" />
                    </div>
                ...
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="/build/images/user/avatar-3.jpg" alt="user-image" class="user-avtar rounded wid-50 hie-50" />
                    </div>
                    <div class="flex-grow-1 mx-2">
                ...
                <li class="list-group-item">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="/build/images/user/avatar-5.jpg" alt="user-image" class="user-avtar rounded wid-50 hie-50" />
                    </div>
                    <div class="flex-grow-1 mx-2">
                    ...
                    <tbody>
                        ...
                        <td>
                          <div class="row align-items-center">
                            <div class="col-auto pe-0">
                              <img src="/build/images/widget/img-prod-1.jpg" alt="user-image" class="wid-55 hei-55 rounded" />
                            </div>
                            <div class="col">
                      ...
                      <tr>
                        <td>
                          <div class="row align-items-center">
                            <div class="col-auto pe-0">
                              <img src="/build/images/widget/img-prod-2.jpg" alt="user-image" class="wid-55 hei-55 rounded" />
                            </div>
                            <div class="col">
                              <h6 class="mb-2"><span class="text-truncate w-100">Foundations Matte Flip Flop</span></h6>
                              <p class="text-muted f-12 mb-0"
                      ...
                      <tr>
                        <td>
                          <div class="row align-items-center">
                            <div class="col-auto pe-0">
                              <img src="/build/images/widget/img-prod-3.jpg" alt="user-image" class="wid-55 hei-55 rounded" />
                            </div>
                            <div class="col">
                              <h6 class="mb-2"><span class="text-truncate w-100">Foundations Matte Flip Flop</span></h6>
                              <p class="text-muted f-12 mb-0"
                      ...
                      <tr>
                        <td>
                          <div class="row align-items-center">
                            <div class="col-auto pe-0">
                              <img src="/build/images/widget/img-prod-4.jpg" alt="user-image" class="wid-55 hei-55 rounded" />
                            </div>
                            <div class="col">
                              <h6 class="mb-2"><span class="text-truncate w-100">Foundations Matte Flip Flop</span></h6>
                              <p class="text-muted f-12 mb-0"
              ...
              <div class="customer-scroll" style="height: 415px; position: relative">
                <div class="card-body p-b-0">
                  <div class="align-middle m-b-25">
                    <img src="/build/images/user/avatar-1.jpg" alt="user image" class="img-radius align-top m-r-15" />
                  ...
                  <div class="align-middle m-b-25">
                    <img src="/build/images/user/avatar-2.jpg" alt="user image" class="img-radius align-top m-r-15" />
                    <div class="d-inline-block">
                      <a href="#!">
                        <h6>John Doue</h6>
                      </a>
                  ...
                  <div class="align-middle m-b-25">
                    <img src="/build/images/user/avatar-3.jpg" alt="user image" class="img-radius align-top m-r-15" />
                    <div class="d-inline-block">
                      <a href="#!">
                        <h6>Alex Thompson</h6>
                      </a>
                  ...
                  <div class="align-middle m-b-25">
                    <img src="/build/images/user/avatar-4.jpg" alt="user image" class="img-radius align-top m-r-15" />
                    <div class="d-inline-block">
                      <a href="#!">
                        <h6>John Doue</h6>
                      </a>
                  ...
                  <div class="align-middle m-b-25">
                    <img src="/build/images/user/avatar-5.jpg" alt="user image" class="img-radius align-top m-r-15" />
                    <div class="d-inline-block">
                      <a href="#!">
                        <h6>Shirley Hoe</h6>
                      </a>
