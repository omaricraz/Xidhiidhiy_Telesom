      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-9">
            <div class="row">
              <!-- prettier-ignore -->
              <x-component-breadcrumb item="Color" text="Bootstrap is supported by an extensive color system that themes our styles and components. This enables more comprehensive customization and extension for any project." link="https://getbootstrap.com/docs/5.2/customize/color"/>
            </div>
            <!-- [ Main Content ] start -->
            <div class="row">
              <!-- [ link-button ] start -->
