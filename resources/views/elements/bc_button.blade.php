      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-9">
            <div class="row">
              <!-- prettier-ignore -->
              <x-component-breadcrumb item="Button" text="Use Bootstrap’s custom button styles for actions in forms, dialogs, and more with support for multiple sizes, states, and more." link="https://getbootstrap.com/docs/5.2/components/buttons"/>
            </div>
            <!-- [ Main Content ] start -->
                  ...
                  <div class="card-body pc-component">
                    <div class="d-flex flex-wrap gap-2">
                      <button type="button" class="btn btn-outline-primary d-inline-flex"
                        ><i class="ti ti-thumb-up me-1"></i>Primary</button
                      >
                      <button type="button" class="btn btn-outline-secondary d-inline-flex"
                        ><i class="ti ti-camera me-1"></i>Secondary</button
                      >
                      <button type="button" class="btn btn-outline-success d-inline-flex"
                        ><i class="ti ti-circle-check me-1"></i>Success</button
                      >
                      <button type="button" class="btn btn-outline-danger d-inline-flex"
                        ><i class="ti ti-alert-triangle me-1"></i>Danger</button
                      >
                      <button type="button" class="btn btn-outline-warning d-inline-flex"
                        ><i class="ti ti-triangle me-1"></i>Warning</button
                      >
