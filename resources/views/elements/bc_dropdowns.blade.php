      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-9">
            <div class="row">
              <!-- prettier-ignore -->
              <x-component-breadcrumb item="Dropdowns" text="Toggle contextual overlays for displaying lists of links and more with the Bootstrap dropdown plugin." link="https://getbootstrap.com/docs/5.2/components/dropdowns"/>
            </div>
            <!-- [ Main Content ] start -->
