      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-9">
            <div class="row">
              <!-- prettier-ignore -->
              <x-component-breadcrumb item="Advance Modal" text="Use Bootstrap’s JavaScript modal plugin to add dialogs to your site for lightboxes or completely custom content" link="https://getbootstrap.com/docs/5.2/components/modal"/>
            </div>
            <!-- [ Main Content ] start -->
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p> <b>Read:</b> modal windows will probably tell you something important so don't forget to read what they say.</p>
                    <p><b>Look:</b> a modal window enjoys a certain kind of attention; just look at it and appreciate its presence.</p>
