...
<!-- [Page specific CSS] start -->
    <!-- rangeslider css -->
    <link rel="stylesheet" href="/build/css/plugins/bootstrap-slider.min.css" />
    <!-- [Page specific CSS] start -->
@endsection
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-9">
            <div class="row">
              <!-- prettier-ignore -->
              <x-component-breadcrumb item="Range Slider" text="Create an input element in the DOM, and then create an instance of Slider" link="https://seiyria.com/bootstrap-slider"/>
            </div>
            <!-- [ Main Content ] start -->
            <div class="row">
              <!-- [ rangeslider ] start -->
              ...
              <div class="col-lg-4 col-md-6">
                <div class="card">
                  <div class="card-body">
                    ...
                    <br />
                    Note that there is no low track on the single-value slider. The area to lesser than the value of the handle is the
                    selection.
                    <br />
...
@section('scripts')
    ...
    <!-- range slider Js -->
    <script src="/build/js/plugins/bootstrap-slider.min.js"></script>
    <script src="/build/js/elements/ac-rangeslider.js"></script>
