      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-9">
            <div class="row">
              <!-- prettier-ignore -->
              <x-component-breadcrumb item="Breadcrumb" text="Indicate the current page’s location within a navigational hierarchy that automatically adds separators via CSS." link="https://getbootstrap.com/docs/5.2/components/breadcrumb"/>
            </div>
            <!-- [ Main Content ] start -->
            <div class="row">
                ...
                <div class="card">
                  ...
                  <div class="card-body pc-component">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb breadcrumb-default-icon">
                        <li class="breadcrumb-item"
                          ><a href="#!"><i class="ti ti-home-2"></i></a
                        ></li>
                        <li class="breadcrumb-item"><a href="#!">Library</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Data</li>
                      </ol>
