      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-9">
            <div class="row">
              <!-- prettier-ignore -->
              <x-component-breadcrumb item="Badges" text="Documentation and examples for badges, our small count and labeling component." link="https://getbootstrap.com/docs/5.2/components/badge"/>
            </div>
            <!-- [ Main Content ] start -->
            <div class="row">
              <!-- [ badge ] start -->
