...
<x-breadcrumb item="User Management" active="Edit User"/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('tech_stack') is-invalid @enderror" name="tech_stack" value="{{ old('tech_stack', $user->tech_stack) }}" placeholder="Laravel, PHP, JavaScript">
                        @error('tech_stack')
                          <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('status_emoji') is-invalid @enderror" name="status_emoji" value="{{ old('status_emoji', $user->status_emoji) }}" placeholder="😊">
                        @error('status_emoji')
                          <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
