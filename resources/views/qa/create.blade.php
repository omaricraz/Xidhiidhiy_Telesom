                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="mb-3">
                        ...
                        @else
                          <input type="text" class="form-control" value="{{ $teams->first()->name ?? 'N/A' }}" readonly>
                          <input type="hidden" name="team_id" value="{{ Auth::user()->team_id }}">
                          <small class="form-text text-muted">Team Leads can only create questions for their team</small>
                        @endif
                        @error('team_id')
                          <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
