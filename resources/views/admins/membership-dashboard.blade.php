...
<x-breadcrumb item="Membership" active="Dashboard"/>
              ...
              <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item px-0 py-2">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/user/avatar-5.jpg" alt="img" class="wid-40 rounded-circle" />
                      </div>
                      <div class="flex-grow-1 mx-3">
                        <h6 class="mb-1">Airi canceled in 2 months membership</h6>
                      </div>
                  ...
                  <li class="list-group-item px-0 py-2">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/user/avatar-6.jpg" alt="img" class="wid-40 rounded-circle" />
                      </div>
                      <div class="flex-grow-1 mx-3">
                        <h6 class="mb-1">Colleen join Addicted membership</h6>
                      </div>
...
<!-- [Page Specific JS] start -->
    ...
    <script src="/build/js/pages/membership-dashboard.js"></script>
    <!-- custom widgets js -->
    <script src="/build/js/widgets/revenue-analytics-chart.js"></script>
    <script src="/build/js/widgets/membership-state-chart.js"></script>
    <script src="/build/js/widgets/membership-activity-line-chart.js"></script>
