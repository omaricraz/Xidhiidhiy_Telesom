...
<x-breadcrumb item="Online Courses" active="Dashboard"/>
              ...
              <div class="card-body px-0 py-2">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/admin/img-bootstrap.svg" alt="img" class="wid-40 rounded" />
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/admin/img-php.svg" alt="img" class="wid-40 rounded" />
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/admin/img-ux.svg" alt="img" class="wid-40 rounded" />
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/admin/img-web.svg" alt="img" class="wid-40 rounded" />
                      </div>
              ...
              <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item px-0 py-2">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/user/avatar-2.jpg" alt="img" class="wid-40 rounded-circle" />
                      </div>
                  ...
                  <li class="list-group-item px-0 py-2">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/user/avatar-1.jpg" alt="img" class="wid-40 rounded-circle" />
                      </div>
                  ...
                  <li class="list-group-item px-0 py-2">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/user/avatar-3.jpg" alt="img" class="wid-40 rounded-circle" />
                      </div>
                  ...
                  <li class="list-group-item px-0 py-2">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/user/avatar-4.jpg" alt="img" class="wid-40 rounded-circle" />
                      </div>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img src="/build/images/user/avatar-4.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img src="/build/images/user/avatar-1.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img src="/build/images/user/avatar-2.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img src="/build/images/user/avatar-3.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img src="/build/images/user/avatar-5.jpg" alt="user image" class="img-radius wid-40 align-top m-r-15" />
                            </div>
                            <div class="flex-grow-1 ms-3">
              ...
              <div class="card-body px-0 py-2">
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="/build/images/admin/img-c.svg" alt="img" class="wid-40 rounded" />
                      </div>
...
<!-- [Page Specific JS] start -->
    ...
    <script src="/build/js/plugins/peity-vanilla.min.js"></script>

    <!-- custom widgets js -->
    <script src="/build/js/widgets/revenue-sales-chart.js"></script>
    <script src="/build/js/widgets/invites-goal-chart.js"></script>
    <script src="/build/js/widgets/course-report-bar-chart.js"></script>
    <script src="/build/js/widgets/total-revenue-line-1-chart.js"></script>
    <script src="/build/js/widgets/total-revenue-line-2-chart.js"></script>
    <script src="/build/js/widgets/student-states-chart.js"></script>
    <script src="/build/js/widgets/activity-line-chart.js"></script>
    <script src="/build/js/widgets/widget-calender.js"></script>
    <script src="/build/js/widgets/visitors-bar-chart.js"></script>
    <script src="/build/js/widgets/earning-courses-line-chart.js"></script>
    <script src="/build/js/widgets/table-donut.js"></script>
