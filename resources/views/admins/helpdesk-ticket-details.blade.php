...
<x-breadcrumb item="Helpdesk" active="Ticket Details"/>
                ...
                <div class="row align-items-center">
                  <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-sm my-2 btn-light-warning"
                      ><i class="mx-2 feather icon-edit"></i>Post a Note</button
                    >
                ...
                <div class="row">
                  <div class="col-sm-auto mb-3 mb-sm-0">
                    <div class="d-sm-inline-block d-flex align-items-center">
                      <img class="wid-60 img-radius mb-2" src="/build/images/user/avatar-5.jpg" alt="Generic placeholder image " />
...
&lt;/pre&gt;
              ...
              <div class="border-bottom card-body">
                <div class="row">
                  <div class="col-sm-auto mb-3 mb-sm-0">
                    <div class="d-sm-inline-block d-flex align-items-center">
                      <img class="wid-60 img-radius mb-2" src="/build/images/user/avatar-4.jpg" alt="Generic placeholder image " />
                      <div class="ms-3 ms-sm-0 text-sm-center">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="alert alert-success d-block text-center text-uppercase"
                  ><i class="feather icon-check-circle mx-2"></i>Verified Purchase</div
                >
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body">
                      <p class="mb-0"
                        ><img src="/build/images/user/avatar-5.jpg" alt="" class="wid-20 rounded me-1 img-fluid" /><a
                          href="#"
                ...
                <li class="list-group-item">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body">
                      <p class="mb-0"
                        ><img src="/build/images/admin/p1.jpg" alt="" class="wid-20 rounded me-1 img-fluid" /><a
                          href="#"
                          class="link-secondary"
                          >Alpha pro</a
                        ></p
                ...
                <li class="list-group-item">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body">
                      <p class="mb-0"
                        ><img src="/build/images/user/avatar-4.jpg" alt="" class="wid-20 rounded me-1 img-fluid" /><a
                          href="#"
                          class="link-secondary"
                          >Lina Hop</a
                        ></p
