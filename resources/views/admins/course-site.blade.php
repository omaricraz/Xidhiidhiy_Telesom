...
<x-breadcrumb item="Online Courses" active="Site"/>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane show active" id="contactDetail">
                      ...
                      <p class="text-muted mb-4"
                        >Incorporate a custom logo and favicon, and fine-tune your school thumbnail to enhance its appearance and
                        branding</p
                      >
                      <div class="row g-3">
                      ...
                      <h5>Color Palette</h5>
                      <p class="text-muted mb-4"
                        >Select a predefined color scheme to establish consistency across your site and products. Alternatively, customize
                        ...
                        <div class="col-md-10 col-lg-8 col-xxl-6">
                          <div class="card border text-center">
                            <div class="card-body">
                              ...
                              <img src="/build/images/admin/img-domain.png" alt="images" class="img-fluid mb-4" />
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="d-flex flex-column gap-3 align-items-center mb-4">
                                <img src="/build/images/admin/img-add-user.png" alt="img" class="img-fluid" />
...
@section('scripts')
    ...
    <script src="/build/js/plugins/wizard.min.js"></script>
