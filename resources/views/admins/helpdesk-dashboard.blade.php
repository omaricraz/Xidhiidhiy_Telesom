...
<x-breadcrumb item="Helpdesk" active="Dashboard"/>
...
<!-- [Page Specific JS] start -->
    ...
    <!-- custom widget js -->
    <script src="/build/js/widgets/support-chart.js"></script>
    <script src="/build/js/widgets/support-chart1.js"></script>
    <script src="/build/js/widgets/support-chart2.js"></script>
    <script src="/build/js/widgets/satisfaction-chart.js"></script>
    <script>
