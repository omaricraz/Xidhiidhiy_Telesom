...
<x-breadcrumb item="Invoice" active="List"/>
              ...
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <p class="text-white mb-1 d-flex align-items-center gap-2">Total Recievables <i data-feather="alert-circle"></i></p>
                  ...
                  <li class="nav-item" role="presentation">
                    ...
                    >
                      <span class="d-flex align-items-center gap-2"
                        >Unpaid <span class="avtar rounded-circle bg-light-warning">2</span></span
                      >
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    ...
                    >
                      <span class="d-flex align-items-center gap-2"
                        >Cancelled <span class="avtar rounded-circle bg-light-danger">1</span></span
                      >
                    </button>
                  </li>
                </ul>
                        ...
                        <tbody>
                            ...
                            <td>
                              <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                  <img src="/build/images/user/avatar-5.jpg" alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                </div>
                                <div class="col">
                                  <h6 class="mb-1"><span class="text-truncate w-100">Mickie Melmoth</span> </h6>
                                  <p class="f-12 mb-0"
                                    ><a href="#!" class="text-muted"><span class="text-truncate w-100">mmsht23@gmail.com</span></a></p
                                  >
                                </div>
                              </div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                  <img src="/build/images/user/avatar-9.jpg" alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                </div>
                                <div class="col">
                                  <h6 class="mb-1"><span class="text-truncate w-100">Shelba Thews</span> </h6>
                                  <p class="f-12 mb-0"
                                    ><a href="#!" class="text-muted"><span class="text-truncate w-100">Shelba Thews</span></a></p
                                  >
                                </div>
                              </div>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                  <img src="/build/images/user/avatar-10.jpg" alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                </div>
                                <div class="col">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                  <img src="/build/images/user/avatar-1.jpg" alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                </div>
                                <div class="col">
                                  <h6 class="mb-1"><span class="text-truncate w-100">Mickie Melmoth</span> </h6>
                                  <p class="f-12 mb-0"
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                  <img src="/build/images/user/avatar-2.jpg" alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                </div>
                                <div class="col">
                                  <h6 class="mb-1"><span class="text-truncate w-100">Shelba Thews</span> </h6>
                                  <p class="f-12 mb-0"
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                  <img src="/build/images/user/avatar-3.jpg" alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                </div>
                                <div class="col">
                                  <h6 class="mb-1"><span class="text-truncate w-100">tass23@gmail.com</span> </h6>
                                  <p class="f-12 mb-0"
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                  <img src="/build/images/user/avatar-4.jpg" alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                </div>
                                <div class="col">
                                  <h6 class="mb-1"><span class="text-truncate w-100">Mickie Melmoth</span> </h6>
                                  <p class="f-12 mb-0"
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                  <img src="/build/images/user/avatar-7.jpg" alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                </div>
                                <div class="col">
                                  <h6 class="mb-1"><span class="text-truncate w-100">Shelba Thews</span> </h6>
                                  <p class="f-12 mb-0"
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row align-items-center">
                                <div class="col-auto pe-0">
                                  <img src="/build/images/user/avatar-8.jpg" alt="user-image" class="wid-40 hei-40 rounded-circle" />
                                </div>
                                <div class="col">
                                  <h6 class="mb-1"><span class="text-truncate w-100">tass23@gmail.com</span> </h6>
                                  <p class="f-12 mb-0"
...
@section('scripts')
    ...
    <script src="/build/js/pages/invoice-list.js"></script>
