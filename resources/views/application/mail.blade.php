...
@section('css')
    ...
    <!-- dragula css -->
    <link rel="stylesheet" href="/build/css/plugins/dragula.min.css" />
    <!-- quill css -->
    <link rel="stylesheet" href="/build/css/plugins/quill.core.css" />
    <link rel="stylesheet" href="/build/css/plugins/quill.snow.css" />
    <link rel="stylesheet" href="/build/css/plugins/quill.bubble.css" />
                                ...
                                <table class="table table-borderless mb-0 mail-table">
                                  <tbody>
                                    <tr class="unread">
                                      ...
                                      <td>
                                        <div class="d-flex align-items-center">
                                          <img src="/build/images/user/avatar-1.jpg" alt="user-image" class="img-user rounded-circle" />
                                    ...
                                    <tr class="unread">
                                      ...
                                      <td>
                                        <div class="d-flex align-items-center">
                                          <img src="/build/images/user/avatar-2.jpg" alt="user-image" class="img-user rounded-circle" />
                                    ...
                                    <tr class="unread">
                                      ...
                                      <td>
                                        <div class="d-flex align-items-center">
                                          <img src="/build/images/user/avatar-3.jpg" alt="user-image" class="img-user rounded-circle" />
                                    ...
                                    <tr class="unread">
                                      ...
                                      <td>
                                        <div class="d-flex align-items-center">
                                          <img src="/build/images/user/avatar-4.jpg" alt="user-image" class="img-user rounded-circle" />
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="d-flex align-items-center">
                                          <img src="/build/images/user/avatar-5.jpg" alt="user-image" class="img-user rounded-circle" />
                                          <h6 class="mb-0 ms-2 text-truncate">Zachary Chambers </h6>
                                        </div>
                                      </td>
                                      <td>
                          ...
                          <div class="card-body scroll-block">
                            <div class="row g-0 justify-content-center align-items-center h-100">
                              <div class="col-md-8 col-sm-10 text-center">
                                <img src="/build/images/application/img-empty-mail.png" alt="img" class="img-fluid mb-4" />
                          ...
                          <div class="card-body scroll-block">
                            ...
                            <div class="mail-details">
                              ...
                              <p class="text-muted indent-text"
                                ...
                                scrambled it to make a type <b>specimen book</b>. It has survived not only five centuries, but also the leap
                                into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the
                                release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing
                                software like <abbr title="Aldus PageMaker" class="initialism">Aldus PageMaker</abbr> including versions of
                                Lorem Ipsum.
                              </p>
                              <p class="text-muted indent-text"
                              ...
                              <div class="bg-light rounded p-3 my-3">
                                <div class="d-flex align-items-start mb-3">
                                  <img class="rounded-circle img-fluid wid-30" src="/build/images/user/avatar-4.jpg" alt="User image" />
                                  <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-primary"
                                      >On Tue, Nov 1, 2022 at 12:05 AM Sreekumar Ks &lt;tazeanu@company.com&gt; wrote:</p
                                    >
