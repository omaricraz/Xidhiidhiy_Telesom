...
<x-breadcrumb item="Invoice" active="Dashboard"/>
            ...
            <div class="card">
              ...
              <ul class="list-group list-group-flush border-top-0">
                <li class="list-group-item border-0">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="/build/images/user/avatar-10.jpg" alt="user-image" class="user-avtar rounded-circle wid-40 hie-40" />
                    </div>
                ...
                <li class="list-group-item border-0">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="/build/images/user/avatar-2.jpg" alt="user-image" class="user-avtar rounded-circle wid-40 hie-40" />
                    </div>
                    <div class="flex-grow-1 mx-2">
                ...
                <li class="list-group-item border-0">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="/build/images/user/avatar-3.jpg" alt="user-image" class="user-avtar rounded-circle wid-40 hie-40" />
                    </div>
                    <div class="flex-grow-1 mx-2">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="mb-2 mt-3 d-flex align-items-center justify-content-between">
                  <h6 class="mb-0 d-flex align-items-center gap-2"><i class="fas fa-circle text-warning f-12"></i> Pending</h6>
                  <p class="mb-0 text-muted">$3,202</p>
                </div>
                <div class="mb-2 d-flex align-items-center justify-content-between">
                  <h6 class="mb-0 d-flex align-items-center gap-2"><i class="fas fa-circle text-success f-12"></i> Paid</h6>
                  <p class="mb-0 text-muted">$45,050</p>
                </div>
                <div class="mb-2 d-flex align-items-center justify-content-between">
                  <h6 class="mb-0 d-flex align-items-center gap-2"><i class="fas fa-circle text-danger f-12"></i> Overdue</h6>
                  <p class="mb-0 text-muted">$25,000</p>
                </div>
                <div class="d-flex align-items-center justify-content-between">
                  <h6 class="mb-0 d-flex align-items-center gap-2"
                    ><i class="fas fa-circle text-primary text-opacity-25 f-12"></i> Draft</h6
                  >
...
@section('scripts')
    ...
    <script src="/build/js/pages/invoice-dashboard.js"></script>
