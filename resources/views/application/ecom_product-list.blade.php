...
<x-breadcrumb item="E-commerce" active="Products list"/>
        <!-- [ Main Content ] start -->
        <div class="row">
          <!-- [ sample-page ] start -->
          <div class="col-sm-12">
                    ...
                    <tbody>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="/build/images/application/img-prod-1.jpg" alt="user-image" class="wid-40 rounded" />
                            </div>
                            <div class="col">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="/build/images/application/img-prod-2.jpg" alt="user-image" class="wid-40 rounded" />
                            </div>
                            <div class="col">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="/build/images/application/img-prod-3.jpg" alt="user-image" class="wid-40 rounded" />
                            </div>
                            <div class="col">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="/build/images/application/img-prod-4.jpg" alt="user-image" class="wid-40 rounded" />
                            </div>
                            <div class="col">
                              <h6 class="mb-1">Apple Series 4 GPS A38 MM Space</h6>
                              <p class="text-muted f-12 mb-0">Apple Watch SE Smartwatch </p>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="/build/images/application/img-prod-5.jpg" alt="user-image" class="wid-40 rounded" />
                            </div>
                            <div class="col">
                              <h6 class="mb-1">Boat On-Ear Wireless</h6>
                              <p class="text-muted f-12 mb-0">Mic(Bluetooth 4.2, Rockerz 450R</p>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="/build/images/application/img-prod-6.jpg" alt="user-image" class="wid-40 rounded" />
                            </div>
                            <div class="col">
                              <h6 class="mb-1">Fitbit MX30 Smart Watch</h6>
                              <p class="text-muted f-12 mb-0">(MX30- waterproof) watch</p>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="/build/images/application/img-prod-7.jpg" alt="user-image" class="wid-40 rounded" />
                            </div>
                            <div class="col">
                              <h6 class="mb-1">Apple Series 4 GPS A38 MM Space</h6>
                              <p class="text-muted f-12 mb-0">Apple Watch SE Smartwatch </p>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-auto pe-0">
                              <img src="/build/images/application/img-prod-8.jpg" alt="user-image" class="wid-40 rounded" />
                            </div>
                            <div class="col">
                              <h6 class="mb-1">Boat On-Ear Wireless</h6>
                              <p class="text-muted f-12 mb-0">Mic(Bluetooth 4.2, Rockerz 450R</p>
                ...
                <div class="bg-light rounded position-relative">
                  <div class="text-center">
                    <div class="chat-avtar d-inline-flex mx-auto">
                      <img class="img-fluid rounded" src="/build/images/application/img-prod-4.jpg" alt="User image" />
                    </div>
                  </div>
