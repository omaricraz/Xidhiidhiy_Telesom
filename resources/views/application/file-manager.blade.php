...
<html lang="en">
  ...
  <head>
    @@include('../layouts/head-page-meta.html', {'title': 'File Manger'})
    <!-- [Page specific CSS] start -->
    <link rel="stylesheet" href="/build/css/plugins/uppy.min.css" />
  ...
  <body @@bodySetup>
    ...
    <div class="pc-container">
      <div class="pc-content">
        @@include('../layouts/breadcrumb.html', {'breadcrumb-item': 'Application', 'breadcrumb-item-active':'File Manager'})
                    ...
                    <div class="card file-card">
                      <div class="card-body">
                        ...
                        <div class="my-3 text-center">
                          <img src="/build/images/application/img-file-doc.svg" alt="img" class="img-fluid" />
                        </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card file-card">
                      <div class="card-body">
                        ...
                        <div class="my-3 text-center">
                          <img src="/build/images/application/img-file-xls.svg" alt="img" class="img-fluid" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-4">
                          <div>
                            <h6 class="mb-0"><span class="text-truncate w-100">Document-final.docx</span></h6>
                  ...
                  <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card file-card">
                      <div class="card-body">
                        ...
                        <div class="my-3 text-center">
                          <img src="/build/images/application/img-file-pdf.svg" alt="img" class="img-fluid" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-4">
                          <div>
                            <h6 class="mb-0"><span class="text-truncate w-100">Document-final.docx</span></h6>
                  ...
                  <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card file-card">
                      <div class="card-body">
                        ...
                        <div class="my-3 text-center">
                          <img src="/build/images/application/img-file-rar.svg" alt="img" class="img-fluid" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-4">
                          <div>
                            <h6 class="mb-0"><span class="text-truncate w-100">Document-final.docx</span></h6>
                    ...
                    <div class="card file-card">
                      <div class="card-body">
                        ...
                        <div class="my-2 text-center">
                          <img src="/build/images/application/img-file-imgview.jpg" alt="img" class="img-fluid rounded" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between">
                          <div>
                            <h6 class="mb-0"><span class="text-truncate w-100">Document-final.docx</span></h6>
                  ...
                  <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card file-card">
                      <div class="card-body">
                        ...
                        <div class="my-3 text-center">
                          <img src="/build/images/application/img-file-ppt.svg" alt="img" class="img-fluid" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-4">
                          <div>
                            <h6 class="mb-0"><span class="text-truncate w-100">Document-final.docx</span></h6>
                  ...
                  <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card file-card">
                      <div class="card-body">
                        ...
                        <div class="my-3 text-center">
                          <img src="/build/images/application/img-file-ai.svg" alt="img" class="img-fluid" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-4">
                          <div>
                            <h6 class="mb-0"><span class="text-truncate w-100">Document-final.docx</span></h6>
                  ...
                  <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card file-card">
                      <div class="card-body">
                        ...
                        <div class="my-3 text-center">
                          <img src="/build/images/application/img-file-txt.svg" alt="img" class="img-fluid" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-4">
                          <div>
                            <h6 class="mb-0"><span class="text-truncate w-100">Document-final.docx</span></h6>
                  ...
                  <div class="col-md-6 col-lg-4 col-xxl-3">
                    <div class="card file-card">
                      <div class="card-body">
                        ...
                        <div class="my-3 text-center">
                          <img src="/build/images/application/img-file-img.svg" alt="img" class="img-fluid" />
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-4">
                          <div>
                            <h6 class="mb-0"><span class="text-truncate w-100">Document-final.docx</span></h6>
                  ...
                  <table class="table table-borderless file-card">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="/build/images/application/img-file-doc.svg" alt="user-image" class="wid-35" />
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="/build/images/application/img-file-xls.svg" alt="user-image" class="wid-35" />
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="/build/images/application/img-file-pdf.svg" alt="user-image" class="wid-35" />
                            <h6 class="mb-0 ms-2 text-truncate">Document-final.docx</h6>
                          </div>
                        </td>
                        <td>16.3 MB</td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="/build/images/application/img-file-ai.svg" alt="user-image" class="wid-35" />
                            <h6 class="mb-0 ms-2 text-truncate">Document-final.docx</h6>
                          </div>
                        </td>
                        <td>16.3 MB</td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="/build/images/application/img-file-img.svg" alt="user-image" class="wid-35" />
                            <h6 class="mb-0 ms-2 text-truncate">ablepro-design.sketch</h6>
                          </div>
                        </td>
                        <td>16.3 MB</td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="/build/images/application/img-file-ppt.svg" alt="user-image" class="wid-35" />
                            <h6 class="mb-0 ms-2 text-truncate">Document-final.docx</h6>
                          </div>
                        </td>
                        <td>16.3 MB</td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="/build/images/application/img-file-txt.svg" alt="user-image" class="wid-35" />
                            <h6 class="mb-0 ms-2 text-truncate">ablepro-design.sketch</h6>
                          </div>
                        </td>
                        <td>16.3 MB</td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="/build/images/application/img-file-rar.svg" alt="user-image" class="wid-35" />
                            <h6 class="mb-0 ms-2 text-truncate">Document-final.docx</h6>
                          </div>
                        </td>
                        <td>16.3 MB</td>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasFileDesc">
      ...
      <div class="offcanvas-body">
        <div class="my-3 text-center">
          <img src="/build/images/application/img-file-doc.svg" alt="img" class="img-fluid wid-100" />
...
@section('scripts')
    ...
    <script src="/build/js/plugins/uppy.min.js"></script>
    <script>
      const Tus = Uppy.Tus;
