...
@section('css')
  <link rel="stylesheet" href="/build/css/plugins/star-rating.min.css" />
  <style>
    :root {
...
<x-breadcrumb item="Forms" active="Rating"/>

      <!-- [ Main Content ] start -->
      <div class="row">
        <!-- prettier-ignore -->
        <x-link title="Rating" text="A zero-dependency ES6 module that transforms a SELECT with numerical-range values (i.e. 1-5) into a dynamic star rating element." link="https://pryley.github.io/star-rating.js/" />
      </div>
      <div class="row">
        <!-- [ sample-page ] start -->
        <div class="col-sm-12">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-12">
                    <span class="gl-star-rating">
                      ...
                      <span class="gl-star-rating--stars">
                        <span data-value="1" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote" style="pointer-events: none">
                        ...
                        <span data-value="2" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote" style="pointer-events: none">
                        ...
                        <span data-value="3" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote" style="pointer-events: none">
                        ...
                        <span data-value="4" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote" style="pointer-events: none">
                            <circle class="gl-emote-bg" fill="#FFD885" cx="12" cy="12" r="10"></circle>
                        ...
                        <span data-value="5" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote" style="pointer-events: none">
                            <circle class="gl-emote-bg" fill="#FFD885" cx="12" cy="12" r="10"></circle>
      ...
      @endsection
      @section('scripts')
      <script src="/build/js/plugins/star-rating.min.js"></script>
      <script>
        var destroyed = false;
