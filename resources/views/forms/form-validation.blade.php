...
<x-breadcrumb item="Forms" active="Form Validation"/>

        <!-- [ Main Content ] start -->
        <div class="row">
          <!-- prettier-ignore -->
          <x-link title="Bouncer" text="lightweight form validation script that augments native HTML5 form validation elements and attributes." link="https://github.com/cferdinandi/bouncer"/>
        </div>
        <div class="row">
...
@section('scripts')
    ...
    <script src="/build/js/plugins/bouncer.min.js"></script>
    <script src="/build/js/forms/form-validation.js"></script>
