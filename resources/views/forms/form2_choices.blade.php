...
<x-breadcrumb item="Forms" active="Choices"/>

        <!-- [ Main content ] start -->
        <div class="row">
          <!-- prettier-ignore -->
          <x-link title="Choices.js" text="Choices.js is a lightweight, configurable select box/text input plugin. Similar to Select2 and Selectize but without the jQuery dependency." link="https://choices-js.github.io/Choices/"/>
        </div>
        <div class="row">
          <!-- [ form-element ] start -->
          <div class="col-sm-12">
