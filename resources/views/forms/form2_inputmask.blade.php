...
<x-breadcrumb item="Forms" active="Input Mask"/>

        <!-- [ Main Content ] start -->
        <div class="row">
          <!-- prettier-ignore -->
          <x-link title="Imask" text="vanilla javascript input mask wich Input processing is based on a simple idea of comparing states before and after change." link="https://imask.js.org/"/>
        </div>
        <div class="row">
          <!-- [ date-form ] start -->
          <div class="col-md-12">
...
<!-- \[Page Specific JS\] start -->
    <!-- Input mask Js -->
    <script src="/build/js/plugins/imask.min.js"></script>
    <!-- form-picker-custom Js -->
    <script src="/build/js/forms/form-masking-custom.js"></script>
