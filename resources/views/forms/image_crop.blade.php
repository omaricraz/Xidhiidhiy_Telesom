...
@section('css')
    ...
    <!-- cropper css -->
    <link rel="stylesheet" href="/build/css/plugins/croppr.min.css" />
    <!-- [Page specific CSS] end -->
@endsection

@section('content')
<x-breadcrumb item="Forms" active="Image Cropper"/>

        <!-- [ Main Content ] start -->
        <div class="row">
          <!-- prettier-ignore -->
          <x-link title="Cropper" text="JavaScript image cropper for image or canvas element for cropping" link="https://fengyuanchen.github.io/cropperjs/"/>
        </div>
        <div class="row">
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-md-7 mb-3 mb-md-0">
                      <div class="cropper"><img src="/build/images/light-box/l1.jpg" alt="image" id="croppr" /> </div>
                    </div>
                    <div class="col-md-5">
...
<!-- \[Page Specific JS\] start -->
    <!-- cropper js -->
    <script src="/build/js/plugins/croppr.min.js"></script>
    <script src="/build/js/forms/page-croper.js"></script>
