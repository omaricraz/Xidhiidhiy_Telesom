...
@section('content')
<x-breadcrumb item="DataTable" active="Advance Initialization"/>

        <!-- [ Main Content ] start -->
        <div class="row">
          <!-- prettier-ignore -->
          <x-link title="DataTables" text="DataTables is a Javascript HTML table enhancing library. It is a highly flexible tool, built upon the foundations of progressive enhancement, that adds all of these advanced features to any HTML table." link="https://datatables.net/"/>
        </div>
        <div class="row">
